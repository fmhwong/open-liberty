...
public class CustomizerTestServlet extends FATServlet {
    ...
    public void testCustomizer() {
        ...
        // The logged events are doubled because of the added span by the TelemetryServletFilter
        assertThat(TestCustomizer.loggedEvents, containsInAnyOrder("properties", "sampler", "exporter", "tracer", "propagator", "propagator",
