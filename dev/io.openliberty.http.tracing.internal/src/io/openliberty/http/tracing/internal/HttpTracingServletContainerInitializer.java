...
package io.openliberty.http.tracing.internal;
...
@Component(service = { ServletContainerInitializer.class },
           name = "io.openliberty.http.servlet.container.initializer",
           configurationPolicy = ConfigurationPolicy.IGNORE,
           immediate = true,
           property = { "service.vendor=IBM" })
public class HttpTracingServletContainerInitializer implements ServletContainerInitializer {
    ...
    public void onStartup(Set<Class<?>> arg0, ServletContext servletContext) throws ServletException {
        FilterRegistration.Dynamic dynamic =
                        servletContext.addFilter("io.openliberty.servlet.filter", HttpTracingFilter.class);
